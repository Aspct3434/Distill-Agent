...
SYSTEM_DIRECTIVE = (
    ...
    # ── React / Vite / SPA build-and-publish recipe ───────────────────────────
    "A React, Vue, Svelte, or other Vite/Next single-page app is NOT a static "
    "site until it is BUILT. Follow this exact sequence and do not skip the build: "
